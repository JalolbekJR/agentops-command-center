  ...
  return (
    <div className="space-y-6">
      ...
      {categories.map((category) => {
        ...
        return (
          <SectionCard key={category} title={category} description="Plan access, risk posture, and usage meters are visible before a team enables a module.">
                ...
                <article className="data-card-muted flex min-h-[20rem] min-w-0 flex-col justify-between p-4">
                  <div>
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        <p className="text-sm font-semibold text-white">More modules coming</p>
                        <p className="muted-copy mt-2 text-sm">This category is intentionally sparse in the local demo while the marketplace model stays visible.</p>
                      </div>
                      <StatusBadge label="Coming later" tone="warning" />
                    </div>
                    <div className="mt-4 grid grid-cols-2 gap-3">
                      <div className="detail-tile">
                        <p className="meta-label">Tier</p>
                        <p className="mt-1 text-sm font-semibold text-white">Roadmap</p>
                      </div>
                      <div className="detail-tile">
                        <p className="meta-label">Meter</p>
                        <p className="mt-1 text-sm font-semibold text-white">Not active</p>
                      </div>
                    </div>
                  </div>
